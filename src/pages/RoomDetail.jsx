...
const styles = {
  ...
  pinEmpty: { background: 'transparent', border: `3px solid ${theme.danger}`, color: theme.text },
  pinFilled: { background: 'transparent', border: `3px solid ${theme.success}`, color: theme.text },
  pinSelected: {
